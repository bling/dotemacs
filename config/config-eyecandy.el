...
(when (fboundp 'global-prettify-symbols-mode)
  ...
  (add-hook 'typescript-ts-base-mode-hook #'/eyecandy/set-pretty-symbols))
...
(use-package nerd-icons-xref :after xref :config (nerd-icons-xref-mode))
(use-package nerd-icons-grep :after grep :config (nerd-icons-grep-mode))
